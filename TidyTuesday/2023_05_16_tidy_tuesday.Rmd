...
As shown in the data earlier, we understand the strength of a tornado will have an affect on other variables in this data, such as property damage and injuries. From here, we will be following along with the steps used in [Julia Silge's screencast](#0), building a
